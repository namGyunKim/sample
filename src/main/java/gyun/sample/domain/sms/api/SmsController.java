...
public class SmsController {
    ...
    @PostMapping("/verify")
    public ResponseEntity<RestApiResponse<Boolean>> verify(@Valid @RequestBody SMSRequest smsRequest, BindingResult bindingResult) {
    ...
    public ResponseEntity<RestApiResponse<String>> verifyLoginId(@Valid @RequestBody SMSRequest smsRequest, BindingResult bindingResult) {
    ...
    public ResponseEntity<RestApiResponse<Boolean>> findPassword(@Valid @RequestBody PasswordGetRequest smsRequest, BindingResult bindingResult) {
