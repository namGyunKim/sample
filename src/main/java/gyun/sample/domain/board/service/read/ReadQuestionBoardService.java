...
public class ReadQuestionBoardService implements ReadBoardService {
    ...
    private void boardValidate(Board board) {
        ...
        if (board.getQuestionBoard() == null) {
            throw new GlobalException(ErrorCode.QUESTION_BOARD_NOT_EXIST);
        }
    }
}
