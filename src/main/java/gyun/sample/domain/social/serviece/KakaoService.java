...
public class KakaoService {
    ...
    public KakaoTokenRequest getTokenByCode(String code) {
        try {
            ...
            throw new GlobalException(ErrorCode.KAKAO_API_GET_TOKEN_ERROR,e);
        }
    }
    ...
    public Member getWithSocial(String loginId, AccountRole accountRole, boolean isActive, MemberType memberType, String nickName, String accessToken, String socialKey) {
        // 가입 여부 확인
        Member member = memberRepository.findBySocialKeyAndRoleAndActiveAndMemberType(
                socialKey, accountRole, isActive, memberType).orElseGet(() -> {
